...
{
    class CustomPreferenceAUS : ICustomPreferenceAUS
    {
        public Country? Country { set; get; }
        public int? CENTERLINE_OFFSET
        {
            get; set;
        }

        public DistanceUnits? CENTERLINE_OFFSET_UNIT
        {
            get; set;
        }
        ...
        public Boolean? KEY_GNAF_ORIGINAL
        {
            get; set;
        }

        public Boolean? KEY_POSTAL_CODE_OVERRIDE
        {
            get; set;
        }

        public Boolean? KEY_RETURN_STREET_TYPE_ABBREVS
        {
            get; set;
        }

        public Boolean? KEY_STREET_FRONTAGE
        {
            get; set;
        }
        ...
        public Boolean? USE_ADDRESS_POINT_INTERPOLATION
        {
            get; set;
        }

        public Boolean? USE_CENTERLINE_OFFSET
        {
            get; set;
        }
