...
For more information refer to [‘Getting Started with CSharp SDK’](https://locate.pitneybowes.com/docs/location-intelligence/v1/en/index.html#C_sdk/java_gettingstart.html) section in documentation.
