...
namespace pb.locationIntelligence.Test
{
    ...
    public class LIAPIGeoEnrichServiceApiTests
    {
        ...
        public void GetPOIsByLocationTest()
        {
            ...
            //string fuzzyOnName = null;
            //string page = null;
            //var response = instance.GetPOIsByLocation(longitude, latitude, name, type, categoryCode, sicCode, maxCandidates, searchRadius, searchRadiusUnit, travelTime, travelTimeUnit, travelDistance, travelDistanceUnit, travelMode, sortBy, fuzzyOnName, page);
            //Assert.IsInstanceOf<GeoEnrichResponse> (response, "response is GeoEnrichResponse");
        }
        ...
        public void PoisAutocompleteTest()
        {
            ...
            //string maxCandidates = null;
            //string sortBy = null;
            //var response = instance.PoisAutocomplete(longitude, latitude, name, searchRadius, searchRadiusUnit, travelTime, travelTimeUnit, travelDistance, travelDistanceUnit, travelMode, country, areaName1, areaName3, postcode1, postcode2, ipAddress, autoDetectLocation, type, categoryCode, sicCode, maxCandidates, sortBy);
            //Assert.IsInstanceOf<GeoEnrichResponse> (response, "response is GeoEnrichResponse");
        }
