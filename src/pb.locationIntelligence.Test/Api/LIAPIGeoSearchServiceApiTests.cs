...
namespace pb.locationIntelligence.Test
{
    ...
    public class LIAPIGeoSearchServiceApiTests
    {
        ...
        public void GeoSearchTest()
        {
            ...
            //var response = instance.GeoSearch(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode);
