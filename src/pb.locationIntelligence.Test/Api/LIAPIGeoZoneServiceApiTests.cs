...
namespace pb.locationIntelligence.Test
{
    ...
    public class LIAPIGeoZoneServiceApiTests
    {
        ...
        public void GetTravelBoundaryByDistanceTest()
        {
            ...
            //var response = instance.GetTravelBoundaryByDistance(costs, point, address, costUnit, db, country, maxOffroadDistance, maxOffroadDistanceUnit, destinationSrs, majorRoads, returnHoles, returnIslands, simplificationFactor, bandingStyle, historicTrafficTimeBucket);
        ...
        public void GetTravelBoundaryByTimeTest()
        {
            ...
            //string bandingStyle = null;
            //string historicTrafficTimeBucket = null;
            //var response = instance.GetTravelBoundaryByTime(costs, point, address, costUnit, db, country, maxOffroadDistance, maxOffroadDistanceUnit, destinationSrs, majorRoads, returnHoles, returnIslands, simplificationFactor, bandingStyle, historicTrafficTimeBucket);
            //Assert.IsInstanceOf<TravelBoundaries> (response, "response is TravelBoundaries");
        }
