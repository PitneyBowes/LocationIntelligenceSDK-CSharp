...
namespace pb.locationIntelligence.Test
{
    ...
    public class LIAPIGeocodeServiceApiTests
    {
        ...
        public void GeocodeBatchTest()
        {
            ...
            //var response = instance.GeocodeBatch(datapackBundle, body);
            //Assert.IsInstanceOf<GeocodeServiceResponseList> (response, "response is GeocodeServiceResponseList");
        }
        
        /// <summary>
        /// Test GeocodeServiceV1TransientDatapackBundleReverseGeocodePost
        /// </summary>
        [Test]
        public void GeocodeServiceV1TransientDatapackBundleReverseGeocodePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string datapackBundle = null;
            //ReverseGeocodeRequest body = null;
            //var response = instance.GeocodeServiceV1TransientDatapackBundleReverseGeocodePost(datapackBundle, body);
            //Assert.IsInstanceOf<GeocodeServiceResponseList> (response, "response is GeocodeServiceResponseList");
        }
