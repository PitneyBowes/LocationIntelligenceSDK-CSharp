...
namespace pb.locationIntelligence.Api
{
    ...
    /// </summary>
    public interface ILIAPIGeoEnhanceServiceApi : IApiAccessor
    {
        ...
        /// <param name="mode">Specifies the available mode of commute. This is required when u r trying to do search by travel distance or travel time.Allowed values driving and walking (optional)</param>
        /// <returns>ApiResponse of Locations</returns>
        ApiResponse<Locations> GetEntityByLocationWithHttpInfo (string longitude, string latitude, string brandName = null, string category = null, string maxCandidates = null, string searchRadius = null, string searchRadiusUnit = null, string searchDataset = null, string searchPriority = null, string travelTime = null, string travelTimeUnit = null, string travelDistance = null, string travelDistanceUnit = null, string mode = null);
        /// <summary>
        /// Place By Location.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="mode">Specifies the available mode of commute. This is required when u r trying to do search by travel distance or travel time.Allowed values driving and walking (optional)</param>
        /// <returns>Task of ApiResponse (Locations)</returns>
        System.Threading.Tasks.Task<ApiResponse<Locations>> GetEntityByLocationAsyncWithHttpInfo (string longitude, string latitude, string brandName = null, string category = null, string maxCandidates = null, string searchRadius = null, string searchRadiusUnit = null, string searchDataset = null, string searchPriority = null, string travelTime = null, string travelTimeUnit = null, string travelDistance = null, string travelDistanceUnit = null, string mode = null);
        /// <summary>
        /// Place By Location.
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LIAPIGeoEnhanceServiceApi : ILIAPIGeoEnhanceServiceApi
    {
        private pb.locationIntelligence.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LIAPIGeoEnhanceServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LIAPIGeoEnhanceServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LIAPIGeoEnhanceServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< Locations > GetAddressWithHttpInfo (string latitude, string longitude, string searchRadius = null, string searchRadiusUnit = null)
        {
            ...
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoEnhanceServiceApi->GetAddress");
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoEnhanceServiceApi->GetAddress");

            var localVarPath = "/geoenhance/v1/address/bylocation";
        ...
        {
             ApiResponse<Locations> localVarResponse = GetEntityByLocationWithHttpInfo(longitude, latitude, brandName, category, maxCandidates, searchRadius, searchRadiusUnit, searchDataset, searchPriority, travelTime, travelTimeUnit, travelDistance, travelDistanceUnit, mode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="mode">Specifies the available mode of commute. This is required when u r trying to do search by travel distance or travel time.Allowed values driving and walking (optional)</param>
        /// <returns>ApiResponse of Locations</returns>
        public ApiResponse< Locations > GetEntityByLocationWithHttpInfo (string longitude, string latitude, string brandName = null, string category = null, string maxCandidates = null, string searchRadius = null, string searchRadiusUnit = null, string searchDataset = null, string searchPriority = null, string travelTime = null, string travelTimeUnit = null, string travelDistance = null, string travelDistanceUnit = null, string mode = null)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoEnhanceServiceApi->GetEntityByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoEnhanceServiceApi->GetEntityByLocation");

            var localVarPath = "/geoenhance/v1/poi/bylocation";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="mode">Specifies the available mode of commute. This is required when u r trying to do search by travel distance or travel time.Allowed values driving and walking (optional)</param>
        /// <returns>Task of Locations</returns>
        public async System.Threading.Tasks.Task<Locations> GetEntityByLocationAsync (string longitude, string latitude, string brandName = null, string category = null, string maxCandidates = null, string searchRadius = null, string searchRadiusUnit = null, string searchDataset = null, string searchPriority = null, string travelTime = null, string travelTimeUnit = null, string travelDistance = null, string travelDistanceUnit = null, string mode = null)
        {
             ApiResponse<Locations> localVarResponse = await GetEntityByLocationAsyncWithHttpInfo(longitude, latitude, brandName, category, maxCandidates, searchRadius, searchRadiusUnit, searchDataset, searchPriority, travelTime, travelTimeUnit, travelDistance, travelDistanceUnit, mode);
             return localVarResponse.Data;
        ...
        /// <param name="mode">Specifies the available mode of commute. This is required when u r trying to do search by travel distance or travel time.Allowed values driving and walking (optional)</param>
        /// <returns>Task of ApiResponse (Locations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Locations>> GetEntityByLocationAsyncWithHttpInfo (string longitude, string latitude, string brandName = null, string category = null, string maxCandidates = null, string searchRadius = null, string searchRadiusUnit = null, string searchDataset = null, string searchPriority = null, string travelTime = null, string travelTimeUnit = null, string travelDistance = null, string travelDistanceUnit = null, string mode = null)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoEnhanceServiceApi->GetEntityByLocation");
        ...
        /// <summary>
        /// Place By Location. Identifies and retrieves the nearest neighborhood around a specific location. This GeoEnhance service accepts latitude &amp; longitude as input and returns a place name.
        /// </summary>
        /// <exception cref="pb.locationIntelligence.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="longitude">Longitude of the location.</param>
        /// <param name="latitude">Latitude of the location.</param>
        ...
        public ApiResponse< PlaceByLocations > GetPlaceByLocationWithHttpInfo (string longitude, string latitude, string levelHint = null)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoEnhanceServiceApi->GetPlaceByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoEnhanceServiceApi->GetPlaceByLocation");

            var localVarPath = "/geoenhance/v1/place/bylocation";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< Timezone > GetTimezoneByLocationWithHttpInfo (string timestamp, string longitude, string latitude)
        {
            ...
            if (timestamp == null)
                throw new ApiException(400, "Missing required parameter 'timestamp' when calling LIAPIGeoEnhanceServiceApi->GetTimezoneByLocation");
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoEnhanceServiceApi->GetTimezoneByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoEnhanceServiceApi->GetTimezoneByLocation");

            var localVarPath = "/geoenhance/v1/timezone/bylocation";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
