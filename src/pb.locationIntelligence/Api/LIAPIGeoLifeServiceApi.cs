...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoLifeServiceApi : IApiAccessor
    {
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>ApiResponse of DemographicsV2</returns>
        ApiResponse<DemographicsV2> GetDemographicsByPBKeyWithHttpInfo (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null);
        /// <summary>
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>ApiResponse of Segmentation</returns>
        ApiResponse<Segmentation> GetSegmentationByPBKeyWithHttpInfo (string pbKey);
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>Task of DemographicsV2</returns>
        System.Threading.Tasks.Task<DemographicsV2> GetDemographicsByPBKeyAsync (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null);
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>Task of ApiResponse (DemographicsV2)</returns>
        System.Threading.Tasks.Task<ApiResponse<DemographicsV2>> GetDemographicsByPBKeyAsyncWithHttpInfo (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null);
        /// <summary>
        /// Segmentation By Address.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of Segmentation</returns>
        System.Threading.Tasks.Task<Segmentation> GetSegmentationByPBKeyAsync (string pbKey);
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of ApiResponse (Segmentation)</returns>
        System.Threading.Tasks.Task<ApiResponse<Segmentation>> GetSegmentationByPBKeyAsyncWithHttpInfo (string pbKey);
    ...
    public partial class LIAPIGeoLifeServiceApi : ILIAPIGeoLifeServiceApi
    {
        ...
        /// <summary>
        /// Demographics By PBKey. Provides the demographic details for a specified PB Key. GeoLife &#39;bypbkey&#39; service accepts pbkey as an input to return a specific population segment&#39;s age group, ethnicity, income, purchasing behaviour, commuter patterns and more.
        /// </summary>
        /// <exception cref="pb.locationIntelligence.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pbKey">free form text</param>
        /// <param name="profile">Retrieves the sorted demographic data on the basis of pre-defined profiles that can display the top 3 or top 5 results (by address) either in ascending or descending order.Allowed values Top5Ascending,Top5Descending,Top3Ascending,Top3Descending (optional)</param>
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>DemographicsV2</returns>
        public DemographicsV2 GetDemographicsByPBKey (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null)
        {
             ApiResponse<DemographicsV2> localVarResponse = GetDemographicsByPBKeyWithHttpInfo(pbKey, profile, filter, valueFormat, variableLevel);
             return localVarResponse.Data;
        }
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>ApiResponse of DemographicsV2</returns>
        public ApiResponse< DemographicsV2 > GetDemographicsByPBKeyWithHttpInfo (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null)
        {
            // verify the required parameter 'pbKey' is set
            if (pbKey == null)
                throw new ApiException(400, "Missing required parameter 'pbKey' when calling LIAPIGeoLifeServiceApi->GetDemographicsByPBKey");

            var localVarPath = "/geolife/v2/demographics/bypbkey";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetDemographicsByPBKey", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>Task of DemographicsV2</returns>
        public async System.Threading.Tasks.Task<DemographicsV2> GetDemographicsByPBKeyAsync (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null)
        {
             ApiResponse<DemographicsV2> localVarResponse = await GetDemographicsByPBKeyAsyncWithHttpInfo(pbKey, profile, filter, valueFormat, variableLevel);
             return localVarResponse.Data;
        ...
        /// <param name="variableLevel">The &#39;variableLevel&#39; retrieves demographic facts in response based on the input value (optional, default to Key)</param>
        /// <returns>Task of ApiResponse (DemographicsV2)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DemographicsV2>> GetDemographicsByPBKeyAsyncWithHttpInfo (string pbKey, string profile = null, string filter = null, string valueFormat = null, string variableLevel = null)
        {
            // verify the required parameter 'pbKey' is set
            if (pbKey == null)
                throw new ApiException(400, "Missing required parameter 'pbKey' when calling LIAPIGeoLifeServiceApi->GetDemographicsByPBKey");
        ...
        /// <summary>
        /// Segmentation By PB Key. Provides the segmentation details for a PB Key. GeoLife &#39;segmentation bypbkey&#39; service accepts free form text PB Key as an input to return the lifestyle characteristics of households in terms of their family status, children characteristics, income behaviors, financial preferences and interests.
        /// </summary>
        /// <exception cref="pb.locationIntelligence.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pbKey">free form text</param>
        /// <returns>Segmentation</returns>
        public Segmentation GetSegmentationByPBKey (string pbKey)
        {
             ApiResponse<Segmentation> localVarResponse = GetSegmentationByPBKeyWithHttpInfo(pbKey);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>ApiResponse of Segmentation</returns>
        public ApiResponse< Segmentation > GetSegmentationByPBKeyWithHttpInfo (string pbKey)
        {
            // verify the required parameter 'pbKey' is set
            if (pbKey == null)
                throw new ApiException(400, "Missing required parameter 'pbKey' when calling LIAPIGeoLifeServiceApi->GetSegmentationByPBKey");

            var localVarPath = "/geolife/v1/segmentation/bypbkey";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetSegmentationByPBKey", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of Segmentation</returns>
        public async System.Threading.Tasks.Task<Segmentation> GetSegmentationByPBKeyAsync (string pbKey)
        {
             ApiResponse<Segmentation> localVarResponse = await GetSegmentationByPBKeyAsyncWithHttpInfo(pbKey);
             return localVarResponse.Data;
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of ApiResponse (Segmentation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Segmentation>> GetSegmentationByPBKeyAsyncWithHttpInfo (string pbKey)
        {
            // verify the required parameter 'pbKey' is set
            if (pbKey == null)
                throw new ApiException(400, "Missing required parameter 'pbKey' when calling LIAPIGeoLifeServiceApi->GetSegmentationByPBKey");
