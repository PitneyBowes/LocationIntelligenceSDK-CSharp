...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoLifeServiceApi : IApiAccessor
    {
        ...
        /// <param name="country">3 letter ISO code of the country to be searched.Allowed values USA,CAN,GBR,FRA,IND,ITA,AUS,DEU. (optional)</param>
        ...
        ApiResponse<Demographics> GetDemographicsByAddressWithHttpInfo (string address, string profile = null, string filter = null, string country = null);
        /// <summary>
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>ApiResponse of Demographics</returns>
        ApiResponse<Demographics> GetDemographicsByLocationWithHttpInfo (string longitude, string latitude, string profile = null, string filter = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Demographics> GetDemographicsByAddressAsync (string address, string profile = null, string filter = null, string country = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Demographics>> GetDemographicsByAddressAsyncWithHttpInfo (string address, string profile = null, string filter = null, string country = null);
        /// <summary>
        /// Demographics By Location.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>Task of Demographics</returns>
        System.Threading.Tasks.Task<Demographics> GetDemographicsByLocationAsync (string longitude, string latitude, string profile = null, string filter = null);
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>Task of ApiResponse (Demographics)</returns>
        System.Threading.Tasks.Task<ApiResponse<Demographics>> GetDemographicsByLocationAsyncWithHttpInfo (string longitude, string latitude, string profile = null, string filter = null);
        /// <summary>
        /// Segmentation By Address.
        /// </summary>
        /// <remarks>
    ...
    public partial class LIAPIGeoLifeServiceApi : ILIAPIGeoLifeServiceApi
    {
        ...
        /// <param name="country">3 letter ISO code of the country to be searched.Allowed values USA,CAN,GBR,FRA,IND,ITA,AUS,DEU. (optional)</param>
        /// <returns>Demographics</returns>
        public Demographics GetDemographicsByAddress (string address, string profile = null, string filter = null, string country = null)
        {
             ApiResponse<Demographics> localVarResponse = GetDemographicsByAddressWithHttpInfo(address, profile, filter, country);
        ...
        /// <param name="country">3 letter ISO code of the country to be searched.Allowed values USA,CAN,GBR,FRA,IND,ITA,AUS,DEU. (optional)</param>
        /// <returns>ApiResponse of Demographics</returns>
        public ApiResponse< Demographics > GetDemographicsByAddressWithHttpInfo (string address, string profile = null, string filter = null, string country = null)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeoLifeServiceApi->GetDemographicsByAddress");

            var localVarPath = "/geolife/v1/demographics/byaddress";
        ...
        /// <param name="country">3 letter ISO code of the country to be searched.Allowed values USA,CAN,GBR,FRA,IND,ITA,AUS,DEU. (optional)</param>
        /// <returns>Task of Demographics</returns>
        public async System.Threading.Tasks.Task<Demographics> GetDemographicsByAddressAsync (string address, string profile = null, string filter = null, string country = null)
        {
             ApiResponse<Demographics> localVarResponse = await GetDemographicsByAddressAsyncWithHttpInfo(address, profile, filter, country);
             return localVarResponse.Data;
        ...
        /// <param name="country">3 letter ISO code of the country to be searched.Allowed values USA,CAN,GBR,FRA,IND,ITA,AUS,DEU. (optional)</param>
        /// <returns>Task of ApiResponse (Demographics)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Demographics>> GetDemographicsByAddressAsyncWithHttpInfo (string address, string profile = null, string filter = null, string country = null)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeoLifeServiceApi->GetDemographicsByAddress");
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>Demographics</returns>
        public Demographics GetDemographicsByLocation (string longitude, string latitude, string profile = null, string filter = null)
        {
             ApiResponse<Demographics> localVarResponse = GetDemographicsByLocationWithHttpInfo(longitude, latitude, profile, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>ApiResponse of Demographics</returns>
        public ApiResponse< Demographics > GetDemographicsByLocationWithHttpInfo (string longitude, string latitude, string profile = null, string filter = null)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoLifeServiceApi->GetDemographicsByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoLifeServiceApi->GetDemographicsByLocation");

            var localVarPath = "/geolife/v1/demographics/bylocation";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>Task of Demographics</returns>
        public async System.Threading.Tasks.Task<Demographics> GetDemographicsByLocationAsync (string longitude, string latitude, string profile = null, string filter = null)
        {
             ApiResponse<Demographics> localVarResponse = await GetDemographicsByLocationAsyncWithHttpInfo(longitude, latitude, profile, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">The &#39;filter&#39; parameter retrieves the demographic data based upon specified input themes. (optional)</param>
        /// <returns>Task of ApiResponse (Demographics)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Demographics>> GetDemographicsByLocationAsyncWithHttpInfo (string longitude, string latitude, string profile = null, string filter = null)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoLifeServiceApi->GetDemographicsByLocation");
