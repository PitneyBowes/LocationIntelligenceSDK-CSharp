...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoLocationServiceApi : IApiAccessor
    {
        ...
        ApiResponse<GeoLocation> GetLocationByFixedLineWithHttpInfo (string deviceId);
        /// <summary>
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>ApiResponse of GeoLocation</returns>
        ApiResponse<GeoLocation> GetLocationByIPAddressWithHttpInfo (string ipAddress);
        /// <summary>
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>ApiResponse of GeoLocation</returns>
        ApiResponse<GeoLocation> GetLocationByWiFiAccessPointWithHttpInfo (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null);
        ...
        System.Threading.Tasks.Task<GeoLocation> GetLocationByFixedLineAsync (string deviceId);
        ...
        System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByFixedLineAsyncWithHttpInfo (string deviceId);
        /// <summary>
        /// Location By IP Address.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>Task of GeoLocation</returns>
        System.Threading.Tasks.Task<GeoLocation> GetLocationByIPAddressAsync (string ipAddress);
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>Task of ApiResponse (GeoLocation)</returns>
        System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByIPAddressAsyncWithHttpInfo (string ipAddress);
        /// <summary>
        /// Location by WiFi Access Point.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>Task of GeoLocation</returns>
        System.Threading.Tasks.Task<GeoLocation> GetLocationByWiFiAccessPointAsync (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null);
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>Task of ApiResponse (GeoLocation)</returns>
        System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByWiFiAccessPointAsyncWithHttpInfo (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null);
    ...
    public partial class LIAPIGeoLocationServiceApi : ILIAPIGeoLocationServiceApi
    {
        ...
        /// <param name="deviceId">This is the fixed line phone number (US only). This is a mandatory parameter.</param>
        /// <returns>GeoLocation</returns>
        public GeoLocation GetLocationByFixedLine (string deviceId)
        {
             ApiResponse<GeoLocation> localVarResponse = GetLocationByFixedLineWithHttpInfo(deviceId);
        ...
        /// <param name="deviceId">This is the fixed line phone number (US only). This is a mandatory parameter.</param>
        /// <returns>ApiResponse of GeoLocation</returns>
        public ApiResponse< GeoLocation > GetLocationByFixedLineWithHttpInfo (string deviceId)
        {
        ...
        /// <param name="deviceId">This is the fixed line phone number (US only). This is a mandatory parameter.</param>
        /// <returns>Task of GeoLocation</returns>
        public async System.Threading.Tasks.Task<GeoLocation> GetLocationByFixedLineAsync (string deviceId)
        {
             ApiResponse<GeoLocation> localVarResponse = await GetLocationByFixedLineAsyncWithHttpInfo(deviceId);
             return localVarResponse.Data;
        ...
        /// <param name="deviceId">This is the fixed line phone number (US only). This is a mandatory parameter.</param>
        /// <returns>Task of ApiResponse (GeoLocation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByFixedLineAsyncWithHttpInfo (string deviceId)
        {
            // verify the required parameter 'deviceId' is set
            if (deviceId == null)
                throw new ApiException(400, "Missing required parameter 'deviceId' when calling LIAPIGeoLocationServiceApi->GetLocationByFixedLine");
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>GeoLocation</returns>
        public GeoLocation GetLocationByIPAddress (string ipAddress)
        {
             ApiResponse<GeoLocation> localVarResponse = GetLocationByIPAddressWithHttpInfo(ipAddress);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>ApiResponse of GeoLocation</returns>
        public ApiResponse< GeoLocation > GetLocationByIPAddressWithHttpInfo (string ipAddress)
        {
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>Task of GeoLocation</returns>
        public async System.Threading.Tasks.Task<GeoLocation> GetLocationByIPAddressAsync (string ipAddress)
        {
             ApiResponse<GeoLocation> localVarResponse = await GetLocationByIPAddressAsyncWithHttpInfo(ipAddress);
             return localVarResponse.Data;
        ...
        /// <param name="ipAddress">This is the ip address of network connected device. It must be a standard IPv4 octet and a valid external address.</param>
        /// <returns>Task of ApiResponse (GeoLocation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByIPAddressAsyncWithHttpInfo (string ipAddress)
        {
            // verify the required parameter 'ipAddress' is set
            if (ipAddress == null)
                throw new ApiException(400, "Missing required parameter 'ipAddress' when calling LIAPIGeoLocationServiceApi->GetLocationByIPAddress");
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>GeoLocation</returns>
        public GeoLocation GetLocationByWiFiAccessPoint (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null)
        {
             ApiResponse<GeoLocation> localVarResponse = GetLocationByWiFiAccessPointWithHttpInfo(mac, ssid, rsid, speed, accessPoint);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>ApiResponse of GeoLocation</returns>
        public ApiResponse< GeoLocation > GetLocationByWiFiAccessPointWithHttpInfo (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null)
        {
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>Task of GeoLocation</returns>
        public async System.Threading.Tasks.Task<GeoLocation> GetLocationByWiFiAccessPointAsync (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null)
        {
             ApiResponse<GeoLocation> localVarResponse = await GetLocationByWiFiAccessPointAsyncWithHttpInfo(mac, ssid, rsid, speed, accessPoint);
             return localVarResponse.Data;
        ...
        /// <param name="accessPoint">This is the JSON based list of wifi access points in the vicinity of device to be located. This parameter is helpful in case, multiple wifi points are visible and we want to make sure that the location of device is best calculated considering all the access points location. (optional)</param>
        /// <returns>Task of ApiResponse (GeoLocation)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeoLocation>> GetLocationByWiFiAccessPointAsyncWithHttpInfo (string mac = null, string ssid = null, string rsid = null, string speed = null, string accessPoint = null)
        {
