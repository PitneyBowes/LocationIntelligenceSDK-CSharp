...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoPropertyServiceApi : IApiAccessor
    {
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>ApiResponse of GeoPropertyResponse</returns>
        ApiResponse<GeoPropertyResponse> GetGeoPropertyByPBKeyWithHttpInfo (string pbKey);
        /// <summary>
        /// Gets GeoPropertyResponses
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of GeoPropertyResponses</returns>
        ApiResponse<GeoPropertyResponses> GetGeoPropertyByPBKeyBatchWithHttpInfo (GeoPropertyPBKeyRequest body = null);
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of GeoPropertyResponse</returns>
        System.Threading.Tasks.Task<GeoPropertyResponse> GetGeoPropertyByPBKeyAsync (string pbKey);
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of ApiResponse (GeoPropertyResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GeoPropertyResponse>> GetGeoPropertyByPBKeyAsyncWithHttpInfo (string pbKey);
        /// <summary>
        /// Gets GeoPropertyResponses
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of GeoPropertyResponses</returns>
        System.Threading.Tasks.Task<GeoPropertyResponses> GetGeoPropertyByPBKeyBatchAsync (GeoPropertyPBKeyRequest body = null);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (GeoPropertyResponses)</returns>
        System.Threading.Tasks.Task<ApiResponse<GeoPropertyResponses>> GetGeoPropertyByPBKeyBatchAsyncWithHttpInfo (GeoPropertyPBKeyRequest body = null);
    ...
    public partial class LIAPIGeoPropertyServiceApi : ILIAPIGeoPropertyServiceApi
    {
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>GeoPropertyResponse</returns>
        public GeoPropertyResponse GetGeoPropertyByPBKey (string pbKey)
        {
             ApiResponse<GeoPropertyResponse> localVarResponse = GetGeoPropertyByPBKeyWithHttpInfo(pbKey);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>ApiResponse of GeoPropertyResponse</returns>
        public ApiResponse< GeoPropertyResponse > GetGeoPropertyByPBKeyWithHttpInfo (string pbKey)
        {
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of GeoPropertyResponse</returns>
        public async System.Threading.Tasks.Task<GeoPropertyResponse> GetGeoPropertyByPBKeyAsync (string pbKey)
        {
             ApiResponse<GeoPropertyResponse> localVarResponse = await GetGeoPropertyByPBKeyAsyncWithHttpInfo(pbKey);
             return localVarResponse.Data;
        ...
        /// <param name="pbKey">free form text</param>
        /// <returns>Task of ApiResponse (GeoPropertyResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeoPropertyResponse>> GetGeoPropertyByPBKeyAsyncWithHttpInfo (string pbKey)
        {
            // verify the required parameter 'pbKey' is set
            if (pbKey == null)
                throw new ApiException(400, "Missing required parameter 'pbKey' when calling LIAPIGeoPropertyServiceApi->GetGeoPropertyByPBKey");
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>GeoPropertyResponses</returns>
        public GeoPropertyResponses GetGeoPropertyByPBKeyBatch (GeoPropertyPBKeyRequest body = null)
        {
             ApiResponse<GeoPropertyResponses> localVarResponse = GetGeoPropertyByPBKeyBatchWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of GeoPropertyResponses</returns>
        public ApiResponse< GeoPropertyResponses > GetGeoPropertyByPBKeyBatchWithHttpInfo (GeoPropertyPBKeyRequest body = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of GeoPropertyResponses</returns>
        public async System.Threading.Tasks.Task<GeoPropertyResponses> GetGeoPropertyByPBKeyBatchAsync (GeoPropertyPBKeyRequest body = null)
        {
             ApiResponse<GeoPropertyResponses> localVarResponse = await GetGeoPropertyByPBKeyBatchAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (GeoPropertyResponses)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeoPropertyResponses>> GetGeoPropertyByPBKeyBatchAsyncWithHttpInfo (GeoPropertyPBKeyRequest body = null)
        {
