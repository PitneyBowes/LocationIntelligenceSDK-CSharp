...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoRouteServiceApi : IApiAccessor
    {
        ...
        /// <param name="weight">Specifies the maximum weight of a vehicle. Any vehicles over this value will be restricted when determining the route. (optional)</param>
        /// <param name="weightUnit">The unit of weight eg. kg(kilogram), lb(pound), mt(metric ton), t(ton) (optional, default to kg)</param>
        /// <param name="height">Specifies the maximum height of a vehicle. Any vehicles over this value will be restricted when determining the route. (optional)</param>
        /// <param name="heightUnit">The unit of height e.g m(meter), km(kilometer), yd(yard), ft(foot), mi(mile) (optional, default to ft)</param>
        /// <param name="length">Specifies the maximum length of a vehicle. Any vehicles over this value will be restricted when determining the route. (optional)</param>
        /// <param name="lengthUnit">The unit of length eg. m(meter), km(kilometer), yd(yard), ft(foot), mi(mile) (optional, default to ft)</param>
        /// <param name="width">Specifies the maximum width of a vehicle. Any vehicles over this value will be restricted when determining the route. (optional)</param>
    ...
    public partial class LIAPIGeoRouteServiceApi : ILIAPIGeoRouteServiceApi
    {
        ...
        {
             ApiResponse<TravelCostMatrixResponse> localVarResponse = await GetTravelCostMatrixByAddressAsyncWithHttpInfo(startAddresses, endAddresses, db, country, optimizeBy, returnDistance, destinationSrs, distanceUnit, returnTime, timeUnit, majorRoads, returnOptimalRoutesOnly, historicTrafficTimeBucket, useCvr, looseningBarrierRestrictions, vehicleType, weight, weightUnit, height, heightUnit, length, lengthUnit, width, widthUnit);
             return localVarResponse.Data;
        ...
        {
             ApiResponse<TravelCostMatrixResponse> localVarResponse = await GetTravelCostMatrixByLocationAsyncWithHttpInfo(startPoints, endPoints, db, optimizeBy, returnDistance, destinationSrs, distanceUnit, returnTime, timeUnit, majorRoads, returnOptimalRoutesOnly, historicTrafficTimeBucket, useCvr, looseningBarrierRestrictions, vehicleType, weight, weightUnit, height, heightUnit, length, lengthUnit, width, widthUnit);
             return localVarResponse.Data;
