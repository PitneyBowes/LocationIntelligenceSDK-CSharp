...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoSearchServiceApi : IApiAccessor
    {
        ...
        ApiResponse<Locations> GeoSearchWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null);
        ...
        System.Threading.Tasks.Task<Locations> GeoSearchAsync (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Locations>> GeoSearchAsyncWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null);
    ...
    public partial class LIAPIGeoSearchServiceApi : ILIAPIGeoSearchServiceApi
    {
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>Locations</returns>
        public Locations GeoSearch (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null)
        {
             ApiResponse<Locations> localVarResponse = GeoSearchWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country);
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>ApiResponse of Locations</returns>
        public ApiResponse< Locations > GeoSearchWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null)
        {
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>Task of Locations</returns>
        public async System.Threading.Tasks.Task<Locations> GeoSearchAsync (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null)
        {
             ApiResponse<Locations> localVarResponse = await GeoSearchAsyncWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country);
             return localVarResponse.Data;
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>Task of ApiResponse (Locations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Locations>> GeoSearchAsyncWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null)
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
                throw new ApiException(400, "Missing required parameter 'searchText' when calling LIAPIGeoSearchServiceApi->GeoSearch");
