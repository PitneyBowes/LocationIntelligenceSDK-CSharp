...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoSearchServiceApi : IApiAccessor
    {
        ...
        /// <param name="returnAdminAreasOnly">if value set &#39;Y&#39; then it will only do a matching on postcode or areaName1, areaName2, areaName3 and areaName4 fields in the data (optional, default to N)</param>
        /// <param name="includeRangesDetails">if value set &#39;Y&#39; then display all unit info of ranges, if value set &#39;N&#39; then don&#39;t show ranges (optional, default to Y)</param>
        /// <param name="searchType">Preference to control search type of interactive requests. (optional, default to ADDRESS)</param>
    ...
    public partial class LIAPIGeoSearchServiceApi : ILIAPIGeoSearchServiceApi
    {
        ...
        {
             ApiResponse<GeosearchLocations> localVarResponse = GeoSearchWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType);
        ...
        public ApiResponse< GeosearchLocations > GeoSearchWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null)
        {
            ...
            var localVarPath = "/geosearch/v2/locations";
        ...
        {
             ApiResponse<GeosearchLocations> localVarResponse = await GeoSearchAsyncWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType);
             return localVarResponse.Data;
