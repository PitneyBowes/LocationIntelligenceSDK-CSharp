...
namespace pb.locationIntelligence.Api
{
    ...
    /// </summary>
    public interface ILIAPIGeoServiceApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LIAPIGeoServiceApi : ILIAPIGeoServiceApi
    {
        private pb.locationIntelligence.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LIAPIGeoServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LIAPIGeoServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LIAPIGeoServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< AHJPlusPSAPResponse > GetAHJPlusPSAPByAddressWithHttpInfo (string address)
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeoServiceApi->GetAHJPlusPSAPByAddress");
        ...
        public ApiResponse< AHJPlusPSAPResponse > GetAHJPlusPSAPByLocationWithHttpInfo (string longitude, string latitude)
        {
            ...
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoServiceApi->GetAHJPlusPSAPByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoServiceApi->GetAHJPlusPSAPByLocation");
        ...
        public ApiResponse< PSAPResponse > GetPSAPByAddressWithHttpInfo (string address)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeoServiceApi->GetPSAPByAddress");
        ...
        public ApiResponse< PSAPResponse > GetPSAPByLocationWithHttpInfo (string longitude, string latitude)
        {
            // verify the required parameter 'longitude' is set
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling LIAPIGeoServiceApi->GetPSAPByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling LIAPIGeoServiceApi->GetPSAPByLocation");
