...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeoTaxServiceApi : IApiAccessor
    {
        ...
        ApiResponse<TaxDistrictResponse> GetIPDTaxByAddressWithHttpInfo (string address);
        /// <summary>
        ...
        System.Threading.Tasks.Task<TaxDistrictResponse> GetIPDTaxByAddressAsync (string address);
        ...
        System.Threading.Tasks.Task<ApiResponse<TaxDistrictResponse>> GetIPDTaxByAddressAsyncWithHttpInfo (string address);
        /// <summary>
        /// Get IPD Tax for batch requests
        /// </summary>
        /// <remarks>
    ...
    public partial class LIAPIGeoTaxServiceApi : ILIAPIGeoTaxServiceApi
    {
        ...
        /// <param name="address">The address to be searched.</param>
        /// <returns>TaxDistrictResponse</returns>
        public TaxDistrictResponse GetIPDTaxByAddress (string address)
        {
             ApiResponse<TaxDistrictResponse> localVarResponse = GetIPDTaxByAddressWithHttpInfo(address);
             return localVarResponse.Data;
        }
        ...
        /// <param name="address">The address to be searched.</param>
        /// <returns>ApiResponse of TaxDistrictResponse</returns>
        public ApiResponse< TaxDistrictResponse > GetIPDTaxByAddressWithHttpInfo (string address)
        {
        ...
        /// <param name="address">The address to be searched.</param>
        /// <returns>Task of TaxDistrictResponse</returns>
        public async System.Threading.Tasks.Task<TaxDistrictResponse> GetIPDTaxByAddressAsync (string address)
        {
             ApiResponse<TaxDistrictResponse> localVarResponse = await GetIPDTaxByAddressAsyncWithHttpInfo(address);
             return localVarResponse.Data;
        ...
        /// <param name="address">The address to be searched.</param>
        /// <returns>Task of ApiResponse (TaxDistrictResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TaxDistrictResponse>> GetIPDTaxByAddressAsyncWithHttpInfo (string address)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeoTaxServiceApi->GetIPDTaxByAddress");
