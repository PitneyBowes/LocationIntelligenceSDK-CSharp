...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeocodeServiceApi : IApiAccessor
    {
        ...
        ApiResponse<PBKeyResponse> GetPBKeyWithHttpInfo (string address, string country = null);
        /// <summary>
        /// Gets PBKeys
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PBKeyResponse> GetPBKeyAsync (string address, string country = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PBKeyResponse>> GetPBKeyAsyncWithHttpInfo (string address, string country = null);
        /// <summary>
        /// Gets PBKeys
        /// </summary>
        /// <remarks>
    ...
    public partial class LIAPIGeocodeServiceApi : ILIAPIGeocodeServiceApi
    {
        ...
        /// <param name="country">Country ISO code. (optional)</param>
        /// <returns>PBKeyResponse</returns>
        public PBKeyResponse GetPBKey (string address, string country = null)
        {
        ...
        /// <param name="country">Country ISO code. (optional)</param>
        /// <returns>ApiResponse of PBKeyResponse</returns>
        public ApiResponse< PBKeyResponse > GetPBKeyWithHttpInfo (string address, string country = null)
        {
        ...
        /// <param name="country">Country ISO code. (optional)</param>
        /// <returns>Task of PBKeyResponse</returns>
        public async System.Threading.Tasks.Task<PBKeyResponse> GetPBKeyAsync (string address, string country = null)
        {
             ApiResponse<PBKeyResponse> localVarResponse = await GetPBKeyAsyncWithHttpInfo(address, country);
             return localVarResponse.Data;
        ...
        /// <param name="country">Country ISO code. (optional)</param>
        /// <returns>Task of ApiResponse (PBKeyResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PBKeyResponse>> GetPBKeyAsyncWithHttpInfo (string address, string country = null)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling LIAPIGeocodeServiceApi->GetPBKey");
        ...
        /// <summary>
        /// Get Address Gets Address for an input free form PBKey text
        /// </summary>
        /// <exception cref="pb.locationIntelligence.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="key">free form text</param>
        /// <param name="type"> (optional)</param>
        ...
        public ApiResponse< GeocodeServiceResponse > KeyLookupWithHttpInfo (string key, string type = null, string country = null)
        {
            ...
            if (key == null)
                throw new ApiException(400, "Missing required parameter 'key' when calling LIAPIGeocodeServiceApi->KeyLookup");

            var localVarPath = "/geocode-service/v1/keylookup";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// Get List of Address Gets Address for an input free form PBKey text
        /// </summary>
        /// <exception cref="pb.locationIntelligence.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"> (optional)</param>
        /// <returns>GeocodeServiceResponseList</returns>
