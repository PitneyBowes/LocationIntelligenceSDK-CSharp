...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeocodeServiceApi : IApiAccessor
    {
        ...
        ApiResponse<PBKeyResponseList> GetPBKeysWithHttpInfo (PBKeyAddressRequest body);
        /// <summary>
        /// reverse Geocode
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PBKeyResponseList> GetPBKeysAsync (PBKeyAddressRequest body);
        ...
        System.Threading.Tasks.Task<ApiResponse<PBKeyResponseList>> GetPBKeysAsyncWithHttpInfo (PBKeyAddressRequest body);
        /// <summary>
        /// reverse Geocode
        /// </summary>
        /// <remarks>
    ...
    public partial class LIAPIGeocodeServiceApi : ILIAPIGeocodeServiceApi
    {
        ...
        public ApiResponse< GeocodeServiceResponseList > GeocodeBatchWithHttpInfo (GeocodeRequest body, string datapackBundle)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LIAPIGeocodeServiceApi->GeocodeBatch");
            // verify the required parameter 'datapackBundle' is set
            if (datapackBundle == null)
        ...
        /// <param name="body"></param>
        /// <returns>PBKeyResponseList</returns>
        public PBKeyResponseList GetPBKeys (PBKeyAddressRequest body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of PBKeyResponseList</returns>
        public ApiResponse< PBKeyResponseList > GetPBKeysWithHttpInfo (PBKeyAddressRequest body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LIAPIGeocodeServiceApi->GetPBKeys");
        ...
        /// <param name="body"></param>
        /// <returns>Task of PBKeyResponseList</returns>
        public async System.Threading.Tasks.Task<PBKeyResponseList> GetPBKeysAsync (PBKeyAddressRequest body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (PBKeyResponseList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PBKeyResponseList>> GetPBKeysAsyncWithHttpInfo (PBKeyAddressRequest body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LIAPIGeocodeServiceApi->GetPBKeys");
