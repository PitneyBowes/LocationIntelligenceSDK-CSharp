...
namespace pb.locationIntelligence.Api
{
    ...
    public interface ILIAPIGeocodeServiceApi : IApiAccessor
    {
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>ApiResponse of GeocodeServiceResponseList</returns>
        ApiResponse<GeocodeServiceResponseList> GeocodeServiceV1TransientDatapackBundleReverseGeocodePostWithHttpInfo (string datapackBundle, ReverseGeocodeRequest body = null);
        /// <summary>
        /// Gets Capabilities
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>Task of GeocodeServiceResponseList</returns>
        System.Threading.Tasks.Task<GeocodeServiceResponseList> GeocodeServiceV1TransientDatapackBundleReverseGeocodePostAsync (string datapackBundle, ReverseGeocodeRequest body = null);
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>Task of ApiResponse (GeocodeServiceResponseList)</returns>
        System.Threading.Tasks.Task<ApiResponse<GeocodeServiceResponseList>> GeocodeServiceV1TransientDatapackBundleReverseGeocodePostAsyncWithHttpInfo (string datapackBundle, ReverseGeocodeRequest body = null);
        /// <summary>
        /// Gets Capabilities
        /// </summary>
        /// <remarks>
    ...
    public partial class LIAPIGeocodeServiceApi : ILIAPIGeocodeServiceApi
    {
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>GeocodeServiceResponseList</returns>
        public GeocodeServiceResponseList GeocodeServiceV1TransientDatapackBundleReverseGeocodePost (string datapackBundle, ReverseGeocodeRequest body = null)
        {
             ApiResponse<GeocodeServiceResponseList> localVarResponse = GeocodeServiceV1TransientDatapackBundleReverseGeocodePostWithHttpInfo(datapackBundle, body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>ApiResponse of GeocodeServiceResponseList</returns>
        public ApiResponse< GeocodeServiceResponseList > GeocodeServiceV1TransientDatapackBundleReverseGeocodePostWithHttpInfo (string datapackBundle, ReverseGeocodeRequest body = null)
        {
            // verify the required parameter 'datapackBundle' is set
            if (datapackBundle == null)
                throw new ApiException(400, "Missing required parameter 'datapackBundle' when calling LIAPIGeocodeServiceApi->GeocodeServiceV1TransientDatapackBundleReverseGeocodePost");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GeocodeServiceV1TransientDatapackBundleReverseGeocodePost", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>Task of GeocodeServiceResponseList</returns>
        public async System.Threading.Tasks.Task<GeocodeServiceResponseList> GeocodeServiceV1TransientDatapackBundleReverseGeocodePostAsync (string datapackBundle, ReverseGeocodeRequest body = null)
        {
             ApiResponse<GeocodeServiceResponseList> localVarResponse = await GeocodeServiceV1TransientDatapackBundleReverseGeocodePostAsyncWithHttpInfo(datapackBundle, body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Reverse Geocode Request object (optional)</param>
        /// <returns>Task of ApiResponse (GeocodeServiceResponseList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeocodeServiceResponseList>> GeocodeServiceV1TransientDatapackBundleReverseGeocodePostAsyncWithHttpInfo (string datapackBundle, ReverseGeocodeRequest body = null)
        {
            // verify the required parameter 'datapackBundle' is set
            if (datapackBundle == null)
                throw new ApiException(400, "Missing required parameter 'datapackBundle' when calling LIAPIGeocodeServiceApi->GeocodeServiceV1TransientDatapackBundleReverseGeocodePost");
