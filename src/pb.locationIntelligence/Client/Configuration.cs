...
namespace pb.locationIntelligence.Client
{
    ...
    public class Configuration
    {
        ...
        private string oAuthServiceLink= "https://api.pitneybowes.com/oauth/token";
        /// <summary>
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 100000,
                             string userAgent = "Swagger-Codegen/8.5.0/csharp"
                            )
        {
        ...
        {
            String report = "C# SDK (pb.locationIntelligence) Debug Report:\n";
            report += "    OS: " + Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + Assembly
                     .GetExecutingAssembly()
                     .GetReferencedAssemblies()
                     .Where(x => x.Name == "System.Core").First().Version.ToString()  + "\n";
            report += "    Version of the API: 8.5.0\n";
            report += "    SDK Package Version: 8.5.0\n";
...
/// <value>
    ...
    /// </value>
public String OAuthServiceLink
{
get
{
return oAuthServiceLink;
}

set
{
oAuthServiceLink = value;
}
}
