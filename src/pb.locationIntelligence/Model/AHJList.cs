...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class AHJList :  IEquatable<AHJList>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AHJList);
        }

        /// <summary>
        /// Returns true if AHJList instances are equal
        /// </summary>
        /// <param name="other">Instance of AHJList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AHJList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Ahjs != null &&
                    this.Ahjs.SequenceEqual(other.Ahjs)
                );
        }
