...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressBylocation :  IEquatable<AddressBylocation>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressBylocation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddressBylocation);
        }

        /// <summary>
        /// Returns true if AddressBylocation instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressBylocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressBylocation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
