...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetsAndWealthTheme :  IEquatable<AssetsAndWealthTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetsAndWealthTheme" /> class.
        /// </summary>
        ...
        public AssetsAndWealthTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetsAndWealthTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AssetsAndWealthTheme);
        }

        /// <summary>
        /// Returns true if AssetsAndWealthTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetsAndWealthTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetsAndWealthTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
