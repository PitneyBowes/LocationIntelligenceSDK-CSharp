...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttitudesAndMotivationTheme :  IEquatable<AttitudesAndMotivationTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttitudesAndMotivationTheme" /> class.
        /// </summary>
        ...
        public AttitudesAndMotivationTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttitudesAndMotivationTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttitudesAndMotivationTheme);
        }

        /// <summary>
        /// Returns true if AttitudesAndMotivationTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of AttitudesAndMotivationTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttitudesAndMotivationTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
