...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BasicBoundary :  IEquatable<BasicBoundary>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BasicBoundary);
        }

        /// <summary>
        /// Returns true if BasicBoundary instances are equal
        /// </summary>
        /// <param name="other">Instance of BasicBoundary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicBoundary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
