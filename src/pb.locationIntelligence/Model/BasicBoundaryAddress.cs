...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BasicBoundaryAddress :  IEquatable<BasicBoundaryAddress>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BasicBoundaryAddress);
        }

        /// <summary>
        /// Returns true if BasicBoundaryAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of BasicBoundaryAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicBoundaryAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
