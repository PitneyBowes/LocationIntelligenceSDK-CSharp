...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class Birthday :  IEquatable<Birthday>
    {
        ...
        public Birthday(int? Year = null, int? Month = null, int? Day = null)
        {
            this.Year = Year;
            this.Month = Month;
            this.Day = Day;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Birthday);
        }

        /// <summary>
        /// Returns true if Birthday instances are equal
        /// </summary>
        /// <param name="other">Instance of Birthday to be compared</param>
        /// <returns>Boolean</returns>
