...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Boundaries :  IEquatable<Boundaries>
    {
        /// <summary>
        ...
        public Boundaries(List<Boundary> Boundary = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Boundaries);
        }

        /// <summary>
        /// Returns true if Boundaries instances are equal
        /// </summary>
        /// <param name="other">Instance of Boundaries to be compared</param>
        /// <returns>Boolean</returns>
