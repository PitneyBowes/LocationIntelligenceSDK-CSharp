...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class Candidate :  IEquatable<Candidate>
    {
        ...
        /// <param name="WorldGeocoded">WorldGeocoded (default to false).</param>
        public Candidate(int? PrecisionLevel = null, string FormattedStreetAddress = null, string FormattedLocationAddress = null, string Identifier = null, string PrecisionCode = null, string SourceDictionary = null, FieldsMatching Matching = null, GeoPos Geometry = null, GeocodeAddress Address = null, List<CandidateRange> Ranges = null, bool? WorldGeocoded = null)
        {
            ...
            this.Ranges = Ranges;
            // use default value if no "WorldGeocoded" provided
            if (WorldGeocoded == null)
            {
                this.WorldGeocoded = false;
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets WorldGeocoded
        /// </summary>
        [DataMember(Name="worldGeocoded", EmitDefaultValue=false)]
        public bool? WorldGeocoded { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorldGeocoded: ").Append(WorldGeocoded).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Candidate other)
        {
            ...
            return 
                ...
                (
                    this.WorldGeocoded == other.WorldGeocoded ||
                    this.WorldGeocoded != null &&
                    this.WorldGeocoded.Equals(other.WorldGeocoded)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WorldGeocoded != null)
                    hash = hash * 59 + this.WorldGeocoded.GetHashCode();
                return hash;
            }
        }
    }
