...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CategoryMetadata :  IEquatable<CategoryMetadata>
    {
        /// <summary>
        ...
        public CategoryMetadata(string Code = null, string Sic = null, string TradeDivision = null, string TradeGroup = null, string _Class = null, string SubClass = null, string Description = null)
        {
            this.Code = Code;
            this.Sic = Sic;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CategoryMetadata);
        }

        /// <summary>
        /// Returns true if CategoryMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of CategoryMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryMetadata other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
