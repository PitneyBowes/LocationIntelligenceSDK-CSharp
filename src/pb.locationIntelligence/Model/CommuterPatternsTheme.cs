...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommuterPatternsTheme :  IEquatable<CommuterPatternsTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommuterPatternsTheme" /> class.
        /// </summary>
        ...
        public CommuterPatternsTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommuterPatternsTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CommuterPatternsTheme);
        }

        /// <summary>
        /// Returns true if CommuterPatternsTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of CommuterPatternsTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommuterPatternsTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
