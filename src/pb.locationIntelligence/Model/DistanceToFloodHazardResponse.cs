...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistanceToFloodHazardResponse :  IEquatable<DistanceToFloodHazardResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistanceToFloodHazardResponse" /> class.
        /// </summary>
        /// <param name="WaterBodies">WaterBodies.</param>
        public DistanceToFloodHazardResponse(List<WaterBodyResponse> WaterBodies = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DistanceToFloodHazardResponse);
        }

        /// <summary>
        /// Returns true if DistanceToFloodHazardResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DistanceToFloodHazardResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistanceToFloodHazardResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
