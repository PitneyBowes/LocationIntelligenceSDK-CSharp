...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EducationTheme :  IEquatable<EducationTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EducationTheme" /> class.
        /// </summary>
        ...
        public EducationTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EducationTheme);
        }

        /// <summary>
        /// Returns true if EducationTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of EducationTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EducationTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
