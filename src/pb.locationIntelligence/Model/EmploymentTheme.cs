...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmploymentTheme :  IEquatable<EmploymentTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentTheme" /> class.
        /// </summary>
        ...
        public EmploymentTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EmploymentTheme);
        }

        /// <summary>
        /// Returns true if EmploymentTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of EmploymentTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
