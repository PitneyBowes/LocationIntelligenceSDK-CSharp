...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EthnicityTheme :  IEquatable<EthnicityTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthnicityTheme" /> class.
        /// </summary>
        ...
        public EthnicityTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EthnicityTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EthnicityTheme);
        }

        /// <summary>
        /// Returns true if EthnicityTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of EthnicityTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthnicityTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
