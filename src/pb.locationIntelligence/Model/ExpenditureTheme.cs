...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenditureTheme :  IEquatable<ExpenditureTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenditureTheme" /> class.
        /// </summary>
        ...
        public ExpenditureTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExpenditureTheme);
        }

        /// <summary>
        /// Returns true if ExpenditureTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of ExpenditureTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenditureTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
