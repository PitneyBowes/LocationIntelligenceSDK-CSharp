...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FinancialProductsTheme :  IEquatable<FinancialProductsTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialProductsTheme" /> class.
        /// </summary>
        ...
        public FinancialProductsTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinancialProductsTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FinancialProductsTheme);
        }

        /// <summary>
        /// Returns true if FinancialProductsTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of FinancialProductsTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinancialProductsTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
