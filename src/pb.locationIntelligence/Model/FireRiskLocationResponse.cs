...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FireRiskLocationResponse :  IEquatable<FireRiskLocationResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FireRiskLocationResponse);
        }

        /// <summary>
        /// Returns true if FireRiskLocationResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of FireRiskLocationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FireRiskLocationResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
