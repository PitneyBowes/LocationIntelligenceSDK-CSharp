...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FloodRiskResponseList :  IEquatable<FloodRiskResponseList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FloodRiskResponseList" /> class.
        /// </summary>
        /// <param name="FloodRisk">FloodRisk.</param>
        public FloodRiskResponseList(List<FloodRiskResponse> FloodRisk = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FloodRiskResponseList);
        }

        /// <summary>
        /// Returns true if FloodRiskResponseList instances are equal
        /// </summary>
        /// <param name="other">Instance of FloodRiskResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FloodRiskResponseList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
