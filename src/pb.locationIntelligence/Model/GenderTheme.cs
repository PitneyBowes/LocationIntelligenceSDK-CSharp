...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenderTheme :  IEquatable<GenderTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenderTheme" /> class.
        /// </summary>
        ...
        public GenderTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GenderTheme);
        }

        /// <summary>
        /// Returns true if GenderTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of GenderTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenderTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
