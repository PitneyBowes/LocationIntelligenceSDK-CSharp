...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeoplacesResponse :  IEquatable<GeoplacesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeoplacesResponse" /> class.
        /// </summary>
        /// <param name="Poi">Poi.</param>
        /// <param name="MatchedAddress">MatchedAddress.</param>
        public GeoplacesResponse(List<POIPlaces> Poi = null, MatchedAddress MatchedAddress = null)
        {
            this.Poi = Poi;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeoplacesResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GeoplacesResponse);
        }

        /// <summary>
        /// Returns true if GeoplacesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GeoplacesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeoplacesResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
