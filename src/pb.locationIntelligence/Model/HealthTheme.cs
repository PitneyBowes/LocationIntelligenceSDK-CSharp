...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HealthTheme :  IEquatable<HealthTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HealthTheme" /> class.
        /// </summary>
        ...
        public HealthTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HealthTheme);
        }

        /// <summary>
        /// Returns true if HealthTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of HealthTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HealthTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
