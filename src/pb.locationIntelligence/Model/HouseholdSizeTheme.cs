...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HouseholdSizeTheme :  IEquatable<HouseholdSizeTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HouseholdSizeTheme" /> class.
        /// </summary>
        ...
        public HouseholdSizeTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HouseholdSizeTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HouseholdSizeTheme);
        }

        /// <summary>
        /// Returns true if HouseholdSizeTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of HouseholdSizeTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HouseholdSizeTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
