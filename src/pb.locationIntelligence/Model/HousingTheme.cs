...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HousingTheme :  IEquatable<HousingTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HousingTheme" /> class.
        /// </summary>
        ...
        public HousingTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HousingTheme);
        }

        /// <summary>
        /// Returns true if HousingTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of HousingTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HousingTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
