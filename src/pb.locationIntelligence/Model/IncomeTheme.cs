...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncomeTheme :  IEquatable<IncomeTheme>
    {
        /// <summary>
        ...
        public IncomeTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IncomeTheme);
        }

        /// <summary>
        /// Returns true if IncomeTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of IncomeTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
