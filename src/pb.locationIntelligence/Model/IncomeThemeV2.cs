...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncomeThemeV2 :  IEquatable<IncomeThemeV2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeThemeV2" /> class.
        /// </summary>
        ...
        public IncomeThemeV2(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IncomeThemeV2);
        }

        /// <summary>
        /// Returns true if IncomeThemeV2 instances are equal
        /// </summary>
        /// <param name="other">Instance of IncomeThemeV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeThemeV2 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
