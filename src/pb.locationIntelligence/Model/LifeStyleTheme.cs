...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LifeStyleTheme :  IEquatable<LifeStyleTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LifeStyleTheme" /> class.
        /// </summary>
        ...
        public LifeStyleTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LifeStyleTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LifeStyleTheme);
        }

        /// <summary>
        /// Returns true if LifeStyleTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of LifeStyleTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LifeStyleTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
