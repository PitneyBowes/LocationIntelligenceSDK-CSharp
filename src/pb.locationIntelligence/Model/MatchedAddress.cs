...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchedAddress :  IEquatable<MatchedAddress>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MatchedAddress);
        }

        /// <summary>
        /// Returns true if MatchedAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of MatchedAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchedAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
