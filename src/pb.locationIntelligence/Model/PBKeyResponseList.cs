...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PBKeyResponseList :  IEquatable<PBKeyResponseList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PBKeyResponseList" /> class.
        /// </summary>
        /// <param name="Pbkey">Pbkey.</param>
        public PBKeyResponseList(List<PbKey> Pbkey = null)
        {
            this.Pbkey = Pbkey;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PBKeyResponseList);
        }

        /// <summary>
        /// Returns true if PBKeyResponseList instances are equal
        /// </summary>
        /// <param name="other">Instance of PBKeyResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PBKeyResponseList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Pbkey != null &&
                    this.Pbkey.SequenceEqual(other.Pbkey)
                );
        }
