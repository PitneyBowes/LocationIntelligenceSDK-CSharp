...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POIBoundaryAddressRequest :  IEquatable<POIBoundaryAddressRequest>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POIBoundaryAddressRequest);
        }

        /// <summary>
        /// Returns true if POIBoundaryAddressRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of POIBoundaryAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POIBoundaryAddressRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
