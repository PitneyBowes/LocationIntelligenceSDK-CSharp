...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POIBoundaryLocationRequest :  IEquatable<POIBoundaryLocationRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POIBoundaryLocationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POIBoundaryLocationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POIBoundaryLocationRequest" /> class.
        /// </summary>
        ...
        public List<POIBoundaryLocations> Locations { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POIBoundaryLocationRequest);
        }

        /// <summary>
        /// Returns true if POIBoundaryLocationRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of POIBoundaryLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POIBoundaryLocationRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
