...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PoiBoundaryPreferences :  IEquatable<PoiBoundaryPreferences>
    {
        /// <summary>
        ...
        public PoiBoundaryPreferences(string CategoryCode = null, string SicCode = null, string NaicsCode = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PoiBoundaryPreferences);
        }

        /// <summary>
        /// Returns true if PoiBoundaryPreferences instances are equal
        /// </summary>
        /// <param name="other">Instance of PoiBoundaryPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoiBoundaryPreferences other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
