...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Pois :  IEquatable<Pois>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Pois);
        }

        /// <summary>
        /// Returns true if Pois instances are equal
        /// </summary>
        /// <param name="other">Instance of Pois to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Pois other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
