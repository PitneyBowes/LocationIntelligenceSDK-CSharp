...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class Polygon :  IEquatable<Polygon>
    {
        ...
        public Polygon(List<Point> Point = null)
        {
            // to ensure "Point" is required (not null)
            if (Point == null)
            {
                throw new InvalidDataException("Point is a required property for Polygon and cannot be null");
            }
            else
            {
                this.Point = Point;
        ...
        public bool Equals(Polygon other)
        {
            ...
            return 
                (
                    ...
                    this.Point != null &&
                    this.Point.SequenceEqual(other.Point)
                );
        }
