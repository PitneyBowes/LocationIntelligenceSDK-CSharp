...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PopulationTheme :  IEquatable<PopulationTheme>
    {
        /// <summary>
        ...
        public PopulationTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PopulationTheme);
        }

        /// <summary>
        /// Returns true if PopulationTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of PopulationTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PopulationTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
