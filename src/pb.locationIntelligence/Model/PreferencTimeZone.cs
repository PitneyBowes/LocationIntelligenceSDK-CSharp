...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PreferencTimeZone :  IEquatable<PreferencTimeZone>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreferencTimeZone" /> class.
        /// </summary>
        /// <param name="MatchMode">MatchMode.</param>
        public PreferencTimeZone(string MatchMode = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PreferencTimeZone);
        }

        /// <summary>
        /// Returns true if PreferencTimeZone instances are equal
        /// </summary>
        /// <param name="other">Instance of PreferencTimeZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferencTimeZone other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
