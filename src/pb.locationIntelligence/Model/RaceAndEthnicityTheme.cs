...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RaceAndEthnicityTheme :  IEquatable<RaceAndEthnicityTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RaceAndEthnicityTheme" /> class.
        /// </summary>
        ...
        public RaceAndEthnicityTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RaceAndEthnicityTheme {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RaceAndEthnicityTheme);
        }

        /// <summary>
        /// Returns true if RaceAndEthnicityTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of RaceAndEthnicityTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceAndEthnicityTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
