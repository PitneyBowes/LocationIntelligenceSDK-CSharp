...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RaceTheme :  IEquatable<RaceTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RaceTheme" /> class.
        /// </summary>
        ...
        public RaceTheme(string BoundaryRef = null, List<IndividualValueVariable> IndividualValueVariable = null, List<RangeVariable> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RaceTheme);
        }

        /// <summary>
        /// Returns true if RaceTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of RaceTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
