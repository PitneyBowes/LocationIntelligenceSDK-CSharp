...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskPreferences :  IEquatable<RiskPreferences>
    {
        /// <summary>
        ...
        public RiskPreferences(string IncludeGeometry = null, string IncludeZoneDesc = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskPreferences);
        }

        /// <summary>
        /// Returns true if RiskPreferences instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskPreferences other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
