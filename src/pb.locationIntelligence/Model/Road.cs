...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class Road :  IEquatable<Road>
    {
        ...
        public Road(string RoadClass = null, string Name = null, string Type = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Road);
        }

        /// <summary>
        /// Returns true if Road instances are equal
        /// </summary>
        /// <param name="other">Instance of Road to be compared</param>
        /// <returns>Boolean</returns>
