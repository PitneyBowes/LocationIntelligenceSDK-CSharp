...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RouteDelivery :  IEquatable<RouteDelivery>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteDelivery" /> class.
        /// </summary>
        /// <param name="IndividualValueVariable">IndividualValueVariable.</param>
        public RouteDelivery(List<IndividualValueVariable> IndividualValueVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RouteDelivery);
        }

        /// <summary>
        /// Returns true if RouteDelivery instances are equal
        /// </summary>
        /// <param name="other">Instance of RouteDelivery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RouteDelivery other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
