...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SegmentationThemes :  IEquatable<SegmentationThemes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentationThemes" /> class.
        /// </summary>
        /// <param name="LifeStyleTheme">LifeStyleTheme.</param>
        public SegmentationThemes(LifeStyleTheme LifeStyleTheme = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SegmentationThemes);
        }

        /// <summary>
        /// Returns true if SegmentationThemes instances are equal
        /// </summary>
        /// <param name="other">Instance of SegmentationThemes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SegmentationThemes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.LifeStyleTheme == other.LifeStyleTheme ||
                    this.LifeStyleTheme != null &&
                    this.LifeStyleTheme.Equals(other.LifeStyleTheme)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LifeStyleTheme != null)
                    hash = hash * 59 + this.LifeStyleTheme.GetHashCode();
                return hash;
            }
        }
    }
