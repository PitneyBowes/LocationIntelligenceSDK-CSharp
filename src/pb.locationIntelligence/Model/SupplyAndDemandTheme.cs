...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SupplyAndDemandTheme :  IEquatable<SupplyAndDemandTheme>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplyAndDemandTheme" /> class.
        /// </summary>
        ...
        public SupplyAndDemandTheme(string BoundaryRef = null, List<IndividualValueVariableV2> IndividualValueVariable = null, List<RangeVariableV2> RangeVariable = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SupplyAndDemandTheme);
        }

        /// <summary>
        /// Returns true if SupplyAndDemandTheme instances are equal
        /// </summary>
        /// <param name="other">Instance of SupplyAndDemandTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupplyAndDemandTheme other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
