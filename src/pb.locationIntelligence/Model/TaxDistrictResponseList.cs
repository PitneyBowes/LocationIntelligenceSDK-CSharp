...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxDistrictResponseList :  IEquatable<TaxDistrictResponseList>
    {
        /// <summary>
        ...
        public TaxDistrictResponseList(List<TaxDistrictResponse> TaxDistrictResponse = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaxDistrictResponseList);
        }

        /// <summary>
        /// Returns true if TaxDistrictResponseList instances are equal
        /// </summary>
        /// <param name="other">Instance of TaxDistrictResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxDistrictResponseList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.TaxDistrictResponse == other.TaxDistrictResponse ||
                    this.TaxDistrictResponse != null &&
                    this.TaxDistrictResponse.SequenceEqual(other.TaxDistrictResponse)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TaxDistrictResponse != null)
                    hash = hash * 59 + this.TaxDistrictResponse.GetHashCode();
                return hash;
            }
        }
    }
