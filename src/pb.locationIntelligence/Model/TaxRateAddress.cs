...
namespace pb.locationIntelligence.Model
{
    ...
    public partial class TaxRateAddress :  IEquatable<TaxRateAddress>
    {
        ...
        /// <param name="BufferWidth">BufferWidth.</param>
        /// <param name="UserBufferWidth">UserBufferWidth.</param>
        public TaxRateAddress(string ObjectId = null, string MainAddressLine = null, string AddressLastLine = null, string PlaceName = null, string AreaName1 = null, string AreaName2 = null, string AreaName3 = null, string AreaName4 = null, string PostCode1 = null, string PostCode2 = null, string Country = null, string AddressNumber = null, string StreetName = null, string UnitType = null, string UnitValue = null, Dictionary<string, Object> CustomFields = null, string DistanceUnits = null, string BufferWidth = null, string UserBufferWidth = null)
        {
        ...
        /// <summary>
        /// Gets or Sets BufferWidth
        /// </summary>
        [DataMember(Name="bufferWidth", EmitDefaultValue=false)]
        public string BufferWidth { get; set; }
        /// <summary>
        /// Gets or Sets UserBufferWidth
        /// </summary>
        [DataMember(Name="userBufferWidth", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BufferWidth: ").Append(BufferWidth).Append("\n");
            sb.Append("  UserBufferWidth: ").Append(UserBufferWidth).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(TaxRateAddress other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.BufferWidth.Equals(other.BufferWidth)
                ) && 
                (
                    this.UserBufferWidth == other.UserBufferWidth ||
                    this.UserBufferWidth != null &&
                    this.UserBufferWidth.Equals(other.UserBufferWidth)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BufferWidth != null)
                    hash = hash * 59 + this.BufferWidth.GetHashCode();
                if (this.UserBufferWidth != null)
                    hash = hash * 59 + this.UserBufferWidth.GetHashCode();
                return hash;
            }
        }
    }
