...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxRateBatchResponse :  IEquatable<TaxRateBatchResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaxRateBatchResponse);
        }

        /// <summary>
        /// Returns true if TaxRateBatchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TaxRateBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxRateBatchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
