...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TravelBoundaries :  IEquatable<TravelBoundaries>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TravelBoundaries" /> class.
        /// </summary>
        /// <param name="TravelBoundary">TravelBoundary.</param>
        public TravelBoundaries(TravelBoundary TravelBoundary = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TravelBoundaries);
        }

        /// <summary>
        /// Returns true if TravelBoundaries instances are equal
        /// </summary>
        /// <param name="other">Instance of TravelBoundaries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TravelBoundaries other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.TravelBoundary == other.TravelBoundary ||
                    this.TravelBoundary != null &&
                    this.TravelBoundary.Equals(other.TravelBoundary)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TravelBoundary != null)
                    hash = hash * 59 + this.TravelBoundary.GetHashCode();
                return hash;
            }
        }
    }
