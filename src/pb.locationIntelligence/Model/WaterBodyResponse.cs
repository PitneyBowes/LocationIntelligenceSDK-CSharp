...
namespace pb.locationIntelligence.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WaterBodyResponse :  IEquatable<WaterBodyResponse>
    {
        /// <summary>
        ...
        public WaterBodyResponse(List<WaterBody> WaterBody = null, Address MatchedAddress = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WaterBodyResponse);
        }

        /// <summary>
        /// Returns true if WaterBodyResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of WaterBodyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WaterBodyResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
